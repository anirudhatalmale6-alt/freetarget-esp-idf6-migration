...
void status_LED_test(void)
{
   ...
   *
   * but the exact combination you intended is a guess on my part, so I have
   * left it for you. It is diagnostic output inside status_LED_test() only -
   * nothing else depends on it. Same in your master package.
   */
