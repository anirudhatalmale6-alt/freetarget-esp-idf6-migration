...
bool         contains(const char *s1, const char *s2); // TODO(IDF6): const - callers pass req->uri, which is const                              // Return true if s1 contains s2
...
void         squish(const char *source, char *destination); // TODO(IDF6): source is const - callers pass req->uri                   // Convert the uri into an arguement
