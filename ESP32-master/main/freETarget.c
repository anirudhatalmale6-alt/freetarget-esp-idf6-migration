...
)
{
   ...
   *
   * I have NOT changed it to NULL, deliberately. Every one of the 17 call
   * sites dereferences the result immediately without a NULL check -
   ...
   * either way and this is your production tree.
   */
